  ...
  if (!token) {
    return (
      <div className="min-h-screen bg-stone-50 flex items-center justify-center p-6 text-center">
        <div className="max-w-md w-full bg-white p-6 md:p-10 rounded-xl shadow-lg border border-stone-100">
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex items-center justify-center p-6 font-sans">
      <div className="max-w-md w-full animate-in fade-in zoom-in duration-500">
        <div className="bg-white rounded-[2.5rem] shadow-lg shadow-indigo-100/50 border border-stone-100 overflow-hidden text-stone-900">
          <div className="bg-indigo-600 p-5 md:p-8 sm:p-6 text-center relative overflow-hidden">
            ...
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/20  rounded-xl flex items-center justify-center mx-auto mb-6 shadow-lg border border-white/30 rotate-3">
          ...
          <div className="p-7 sm:p-6 md:p-10 text-center">
            ...
            <div className="flex justify-center gap-3 mb-10">
              {pin.map((digit, i) => (
                <input
                  ...
                  className={`w-12 h-16 sm:w-14 sm:h-18 text-center text-2xl sm:text-3xl font-black bg-stone-50 border-2 rounded-xl transition-all duration-300 outline-none
                                        ${
                                          success
            ...
            {!loading && !success && (
              <button
                ...
                className="group flex items-center justify-center gap-2 w-full py-4 bg-stone-900 hover:bg-black text-white rounded-xl font-bold transition-all shadow-lg hover:shadow-stone-300 uppercase tracking-widest text-xs"
              >
                Konfirmasi PIN
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-stone-50 flex items-center justify-center p-6">
          <div className="max-w-md w-full bg-white p-6 md:p-10 rounded-xl shadow-lg flex flex-col items-center gap-4">
