    ...
    const result = await prisma.$transaction([
      prisma.jadwalUjian.upsert({
        ...
        update: {
          ...
          tempat_santri: examSession.location || "Pesantren Al Imam Al Islami",
          waktu_mulai_ortu: examSession.start_time,
          waktu_selesai_ortu: examSession.end_time,
          tempat_ortu: examSession.location || "Pesantren Al Imam Al Islami",
        },
        create: {
          pendaftar_id,
          tahun_ajaran_id,
    ...
    try {
      ...
      if (pendaftar?.no_hp) {
        ...
        await notifyTestSchedule({
          ...
          tempat: examSession.location || "Pesantren Al Imam Al Islami",
        });
      }
    } catch (waError) {
