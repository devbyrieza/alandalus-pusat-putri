...
const HeroStat = ({
  ...
  >
    <div className="w-12 h-12 rounded-xl bg-primary-50 flex items-center justify-center text-primary-600 mb-3 border border-primary-100 shadow-md">
...
export default function FasilitasPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      try {
        const saved = localStorage.getItem("alandalus_pusat-putri_fasilitas_visit_draft");
        if (saved) {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      try {
        localStorage.setItem("alandalus_pusat-putri_fasilitas_visit_draft", JSON.stringify(visitForm));
      } catch (e) {
...
Mohon konfirmasi kesediaan waktu kunjungan tersebut. Terima kasih.`;
    ...
    if (typeof window !== "undefined") {
      localStorage.removeItem("alandalus_pusat-putri_fasilitas_visit_draft");
    }
  };
        ...
        <Container className="relative z-10">
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              {/* Floating Badge */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-5 rounded-[2rem] shadow-lg border border-primary-100 flex flex-col items-center gap-1 z-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              >
                <div className="app-card bg-white p-5 md:p-8 sm:p-6 lg:p-16 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-500">
                  ...
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-primary-50 rounded-xl flex items-center justify-center text-primary-700 mb-8 sm:mb-10 shadow-md transition-transform group-hover:scale-110 border border-primary-100">
                  ...
                  <h3 className="text-3xl sm:text-2xl md:text-4xl lg:text-3xl font-black text-primary-950 mb-6 leading-[1.1]">
                    Masjid Area <br className="hidden sm:block" /> Putri
                  </h3>
                  <p className="text-base sm:text-lg lg:text-xl text-primary-950/70 mb-8 sm:mb-10 leading-relaxed font-medium">
                    Pusat peribadatan santriwati yang mampu menampung jamaah dengan suasana nyaman.
      ...
      <section className="py-24 md:py-32 bg-white">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 max-w-5xl mx-auto">
            ...
            >
              <div className="w-12 h-12 bg-primary-50 rounded-xl flex items-center justify-center text-primary-700 mb-5 group-hover:scale-110 transition-transform border border-primary-100 shadow-md">
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
                ...
                >
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      <div className="w-12 h-12 rounded-xl bg-primary-50 flex items-center justify-center text-primary-600 shrink-0 border border-primary-100">
                  ...
                  >
                    <div className="rounded-[1.5rem] overflow-hidden h-[200px] relative bg-primary-50">
                      ...
                      />
                      <div className="absolute bottom-3 left-3 bg-white  px-4 py-2 rounded-xl shadow-md border border-primary-100 flex items-center gap-2 z-10 pointer-events-none">
              ...
              <div className="lg:col-span-7">
                <motion.div
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  className="app-card bg-white p-6 sm:p-6 md:p-10 border border-primary-50 shadow-lg relative overflow-hidden"
                >
                  {formStatus === 'success' ? (
                    <motion.div 
                    ...
                    >
                      ...
                      <button 
                        ...
                        className="px-6 py-3 rounded-xl bg-primary-50 text-primary-700 font-bold hover:bg-primary-100 transition-colors whitespace-nowrap inline-block shrink-0"
                      >
                        Isi Form Kembali
                      </button>
                    </motion.div>
                    ...
                    <form onSubmit={handleVisitSubmit} className="space-y-6">
                      ...
                      <button type="submit" className="w-full py-4 rounded-xl bg-primary-600 text-white font-black text-lg shadow-lg shadow-primary-600/20 hover:bg-primary-700 hover:-translate-y-0.5 hover:shadow-lg transition-all flex items-center justify-center gap-2 mt-2">
