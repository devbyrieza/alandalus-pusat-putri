                ...
                <div key={q.id} className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all space-y-3.5">
                  ...
                  <div className="grid grid-cols-1 gap-2 pt-1">
                    {(q.options || []).map((opt) => (
                      <div
                        key={opt.value}
                        className="p-3 rounded-xl bg-slate-50 border border-slate-100 text-xs font-medium text-slate-800 flex items-start gap-2.5 hover:bg-slate-100/80 transition-colors whitespace-nowrap shrink-0"
                      >
                ...
                <div key={idx} className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all space-y-3.5">
                  ...
                  <div className="grid grid-cols-1 gap-2 pt-1">
                    {(q.options || []).map((opt) => (
                      <div
                        key={opt.value}
                        className="p-3 rounded-xl bg-slate-50 border border-slate-100 text-xs font-medium text-slate-800 flex items-start justify-between gap-2.5 hover:bg-slate-100/80 transition-colors whitespace-nowrap shrink-0"
                      >
                        <span className="font-black text-[#ddc192] bg-[#550000] px-2.5 py-0.5 rounded-md border border-[#550000]">
                          {opt.value}
                        </span>
