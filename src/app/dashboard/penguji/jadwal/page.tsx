...
const CustomTimePicker = ({ value, onChange }: { value: string, onChange: (val: string) => void }) => {
  ...
  return (
    <div className="relative flex items-center justify-center bg-white border border-stone-200 rounded-xl pl-4 pr-10 py-2.5 text-sm font-black text-primary-950 focus-within:ring-2 focus-within:ring-primary-500 shadow-sm w-full">
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-[2rem] p-6 md:p-10 border border-gold-100 shadow-sm app-card overflow-hidden relative">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
          <div className="flex items-center gap-5">
            <div className="w-16 h-16 bg-primary-50 rounded-xl flex items-center justify-center border border-primary-100 shrink-0 shadow-sm">
          ...
          <div className="flex bg-ink-50/50 p-1.5 rounded-xl border border-ink-100 w-full md:w-auto min-w-[320px]">
            <button
                ...
                <div className="grid gap-4">
                  {filteredAssignments.map((item) => (
                    ...
                    >
                      ...
                      {/* Time & Location Row */}
                      <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-4 mb-6 px-4 py-4 bg-primary-50/30 rounded-xl border border-primary-100/50">
                          ...
                          <div className="flex flex-col gap-2">
                            {userId &&
                              ...
                              (item.status_santri === "completed" ? (
                                ...
                                <button
                                  ...
                                  className="w-full py-4 bg-primary-600 hover:bg-primary-700 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl transition-all active:scale-95 shadow-lg shadow-primary-600/20"
                                >
                            ...
                            <div className="flex gap-3 mt-2">
                              <button
                                ...
                                className="flex-1 py-4 bg-white border border-primary-100 text-primary-700 hover:bg-primary-50 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 active:scale-95 shadow-sm"
                              >
                              ...
                              <button
                                ...
                                className="px-4 py-4 border border-red-100 text-red-500 hover:bg-red-50 rounded-xl transition-all flex items-center justify-center active:scale-95 shadow-sm"
                                title="Batalkan Jadwal"
                              >
      ...
      {activeTab === "slots" && (
        <>
                ...
                {!isSelectMode ? (
                  <>
                    {slots.length > 0 && (
                      <>
                        <button
                          ...
                          className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-4 bg-stone-50 hover:bg-stone-100 text-stone-600 rounded-xl font-black border border-stone-200 transition-all text-xs uppercase tracking-widest active:scale-95 whitespace-nowrap shrink-0"
                        >
                        ...
                        <button
                          ...
                          className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-4 bg-red-50 hover:bg-red-100 text-red-600 rounded-xl font-black border border-red-200 transition-all text-xs uppercase tracking-widest active:scale-95"
                        >
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-4 bg-primary-50 hover:bg-primary-100 text-primary-700 rounded-xl font-black border border-primary-100 transition-all text-xs uppercase tracking-widest active:scale-95 shadow-sm whitespace-nowrap shrink-0"
                    >
                      <Plus className="w-5 h-5" /> Buat Massal
                    </button>
                    <button
                      onClick={() => setIsSlotModalOpen(true)}
                      className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-black shadow-lg shadow-primary-600/20 transition-all text-xs uppercase tracking-widest active:scale-95"
                    >
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-3 bg-primary-50 text-primary-700 rounded-xl font-black text-xs border border-primary-100 hover:bg-primary-100 transition-all whitespace-nowrap shrink-0"
                    >
          ...
          {isSelectMode && uniqueTimesForChips.length > 1 && (
            <div className="bg-white rounded-xl border border-primary-100 px-5 py-4 flex flex-wrap items-center gap-2">
              ...
              {displaySlots.map((slot: any) => (
                <div
                  ...
                  className={`bg-white rounded-[2rem] p-6 border shadow-sm transition-all group relative app-card ${
                    isSelectMode
                      ...
                      : "hover:shadow-lg hover:shadow-primary-600/5"
                  } ${
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-14 h-14 bg-primary-50 rounded-xl flex items-center justify-center border border-primary-100 text-primary-700 font-black text-xl shadow-sm">
                  ...
                  <div className="space-y-3 mb-2">
                    <div className="flex items-center gap-3 text-primary-900 bg-primary-50/50 p-3 rounded-xl border border-primary-100/30 font-bold text-xs">
      ...
      {isSelectMode && selectedSlotIds.size > 0 && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[55] animate-in slide-in-from-bottom-4 duration-300">
          <div className="flex items-center gap-4 bg-primary-950 text-white px-6 py-4 rounded-[2rem] shadow-lg shadow-primary-950/40">
            <div className="flex items-center gap-2">
        ...
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-[60] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-4 bg-primary-950/40  animate-in fade-in duration-300 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-[32px] shadow-lg w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden border border-white/20 animate-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleBulkEdit} className="p-5 md:p-8 space-y-5 overflow-y-auto overscroll-contain custom-scrollbar flex-1">
              ...
              {/* Lokasi */}
              <div
                className={`p-4 rounded-xl border-2 transition-all ${bulkEditForm.changeLocation ? "border-primary-300 bg-primary-50/30" : "border-stone-100 bg-stone-50/50"}`}
              >
                <label className="flex items-center gap-3 cursor-pointer mb-3">
                  <input
                    type="checkbox"
              ...
              {/* Catatan */}
              <div
                className={`p-4 rounded-xl border-2 transition-all ${bulkEditForm.changeNotes ? "border-primary-300 bg-primary-50/30" : "border-stone-100 bg-stone-50/50"}`}
              >
                <label className="flex items-center gap-3 cursor-pointer mb-3">
                  <input
                    type="checkbox"
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setIsBulkEditModalOpen(false)}
                  className="flex-1 py-3.5 border border-stone-200 text-stone-600 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-stone-50 transition-all"
                >
                  Batal
                </button>
                <button
                  ...
                  className="flex-1 py-3.5 bg-primary-600 hover:bg-primary-700 disabled:opacity-40 text-white rounded-xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary-600/20"
                >
                  {submittingBulkEdit ? (
            ...
            <form onSubmit={handleEditSlot} className="p-5 md:p-8 space-y-5 overflow-y-auto overscroll-contain custom-scrollbar flex-1">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-3.5 bg-primary-600 hover:bg-primary-700 disabled:opacity-50 text-white rounded-xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary-600/20"
                >
                  {submittingEdit ? (
                    <Loader2 className="w-4 h-4 animate-spin" />
                  ) : (
            ...
            <form onSubmit={handleCreateSlot} className="p-5 md:p-8 space-y-6 overflow-y-auto overscroll-contain custom-scrollbar flex-1">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-primary-50 rounded-xl p-4 border border-primary-100 flex items-start gap-3">
                  <div className="w-8 h-8 bg-primary-100 rounded-xl flex items-center justify-center shrink-0 text-primary-600 whitespace-nowrap shrink-0">
              ...
              <button
                ...
                className="w-full py-4 bg-primary-600 hover:bg-primary-700 text-white font-black rounded-xl transition-all shadow-lg shadow-primary-900/20 flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50"
              >
                {submittingSlot ? (
      ...
      {isBulkModalOpen && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-[60] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-4 bg-primary-950/40  animate-in fade-in duration-300 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-[40px] shadow-lg w-full max-w-lg max-h-[90vh] flex flex-col animate-in zoom-in-95 duration-300 border border-white/20">
            {/* Header */}
            ...
            >
              ...
              {/* Jenis Ujian Info */}
              <div className="bg-primary-600 rounded-xl p-6 shadow-lg shadow-primary-950/20 text-white relative overflow-hidden">
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`px-4 py-2.5 rounded-xl text-xs font-black transition-all border relative flex flex-col items-center min-w-[70px] ${
                          isSelected
                            ? isActive
              ...
              {/* Date Range */}
              <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-6 p-6 bg-stone-50 rounded-xl border border-stone-100 shadow-inner">
                <div>
                  ...
                  <input
                    type="date"
                    required
                    className="w-full px-4 py-3 bg-white border border-stone-200 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none font-black text-primary-950 shadow-sm"
              ...
              <div className="bg-stone-50 rounded-[32px] p-5 md:p-8 border border-stone-100">
                ...
                <div className="space-y-4">
                  {(bulkForm.daySlots[activeDay] || []).map((slot, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-4 bg-white p-4 rounded-xl border border-stone-200 shadow-sm hover:shadow-md transition-shadow group"
                    >
                      ...
                      <button
                        ...
                        className="p-3 text-stone-300 hover:text-primary-600 hover:bg-primary-50 rounded-xl transition-all"
                      >
                        <Trash2 className="w-5 h-5" />
                      </button>
                    </div>
              ...
              {/* Informational Alert */}
              <div className="bg-gold-50 rounded-xl p-6 border border-gold-100 flex items-start gap-4">
                <div className="w-10 h-10 bg-gold-400 rounded-xl flex items-center justify-center shrink-0 text-primary-950">
              ...
              <button
                ...
                className="w-full py-5 bg-primary-600 hover:bg-primary-700 text-white font-black rounded-[32px] transition-all shadow-lg shadow-primary-900/40 flex items-center justify-center gap-3 active:scale-95 disabled:opacity-50 text-lg tracking-tight"
              >
                {submittingBulk ? (
