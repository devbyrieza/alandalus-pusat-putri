    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 md:p-6 shadow-sm">
        <div className="flex flex-col sm:flex-row gap-4 sm:items-start">
          <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0 text-blue-600 whitespace-nowrap shrink-0">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-primary-100 text-primary-600 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform whitespace-nowrap shrink-0">
      ...
      <div className="bg-amber-50 border border-amber-200 p-5 rounded-xl space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="bg-white rounded-xl p-4 border border-amber-100 flex gap-3">
            <div className="w-10 h-10 bg-amber-100 rounded-xl flex items-center justify-center flex-shrink-0 whitespace-nowrap shrink-0">
      ...
      <div className="bg-white rounded-xl border border-ink-100 shadow-sm overflow-hidden mb-6">
        <div className="px-6 py-4 border-b border-primary-100 bg-primary-50 flex items-center gap-3">
          <div className="w-9 h-9 bg-primary-100 rounded-xl flex items-center justify-center whitespace-nowrap shrink-0">
        ...
        <div className="p-5 space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-6 h-6 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center font-black text-xs shadow-sm whitespace-nowrap shrink-0">
                1
              </div>
      ...
      <div className="bg-white rounded-xl border border-ink-100 shadow-sm overflow-hidden mt-6">
        <div className="px-6 py-4 border-b border-ink-100 bg-blue-50 flex items-center gap-3">
          <div className="w-9 h-9 bg-blue-100 rounded-xl flex items-center justify-center whitespace-nowrap shrink-0">
