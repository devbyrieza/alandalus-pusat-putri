          ...
          {dokumen.status !== "pending" && dokumen.file_name && (
            <div className="mb-6 bg-white p-4 rounded-2xl border border-ink-100 shadow-sm relative overflow-hidden">
              ...
              {dokumen.status === "verified" && dokumen.verified_at && (
                <div className="mt-4 p-4 bg-rose-50 border border-rose-100 rounded-xl flex gap-3 items-center">
                  <CheckCircle className="w-5 h-5 text-rose-500 shrink-0" />
                  <div>
                    <p className="text-xs font-black text-rose-800 uppercase tracking-wider mb-0.5">
                      Terverifikasi
                    </p>
          ...
          {isLocked ? (
            dokumenList.some((d) => d.status === "rejected") ? (
              ...
              <>
                ...
                <div className="mt-4 p-4 bg-rose-50 border border-emerald-200 rounded-xl flex flex-col sm:flex-row items-center sm:items-start gap-3 text-left">
                  ...
                  <div>
                    ...
                    <p className="text-rose-700 text-xs mt-0.5 font-medium">
                      ...
                      <a
                        ...
                        className="font-black underline hover:text-rose-900"
                      >
                        0812-8530-0800
                      </a>{" "}
