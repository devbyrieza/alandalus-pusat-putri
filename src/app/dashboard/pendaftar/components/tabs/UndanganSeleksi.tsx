      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-sm font-black text-primary-600">6/6 Tahap ✓</span>
          </div>
          <div className="w-full h-3 bg-surface-100 rounded-full overflow-hidden">
            <div className="h-full bg-linear-to-r from-primary-500 to-primary-700 rounded-full w-full shadow-lg shadow-primary-500/20" />
          </div>
          <p className="text-xs text-primary-600 mt-2 font-medium">100% selesai — Semua tahapan seleksi telah dilalui ✓</p>
        </div>
          ...
          {data.current_status === "enrolled" ? (
            <div className="bg-primary-50 rounded-xl border-2 border-pink-200 p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="font-black text-primary-900">Daftar Ulang ✓</h3>
                  <p className="text-xs text-primary-700">Pembayaran daftar ulang telah diterima</p>
                </div>
              </div>
                ...
                <div className="flex items-start justify-between mb-3">
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                      item.completed ? "bg-primary-100" : "bg-primary-50"
                    }`}
                  >
                    <Icon
                      className={`w-5 h-5 ${
                        item.completed ? "text-primary-600" : "text-primary-600"
                      }`}
                    />
                  </div>
                  {item.completed ? (
                    <span className="flex items-center gap-1 px-2.5 py-1 bg-primary-100 text-primary-700 text-xs font-black rounded-full">
