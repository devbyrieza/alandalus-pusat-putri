  ...
  return (
    <div className="space-y-6">
      ...
      {!pengumuman ? (
        ...
        <div className="space-y-6">
          {/* Success Card */}
          <div className="bg-linear-to-r from-rose-500 to-rose-700 rounded-[2rem] p-5 md:p-8 text-white shadow-xl shadow-rose-500/20 relative overflow-hidden app-card">
