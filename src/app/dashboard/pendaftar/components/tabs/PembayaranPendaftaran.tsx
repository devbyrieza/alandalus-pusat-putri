...
function CopyButton({ text, label }: { text: string; label: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-ink-200 hover:bg-surface-50 text-ink-600 text-xs font-bold rounded-xl transition-all active:scale-95 shadow-sm"
      title={`Salin ${label}`}
    >
      {copied ? (
        <>
          <Check className="w-3.5 h-3.5 text-primary-500" />
          <span className="text-primary-600">Disalin</span>
        </>
      ) : (
        <>
  ...
  return (
    <div className="space-y-6">
      ...
      {currentFile && !selectedFile && !isRejected && (
        <div className="p-4 bg-secondary-50 border border-secondary-100 rounded-xl flex items-center gap-4">
      ...
      >
        ...
        {selectedFile ? (
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="relative group/preview">
                {selectedFile.type.startsWith("image/") && previewUrl ? (
                  <div className="relative w-full max-w-sm mx-auto overflow-hidden rounded-xl border border-ink-100 shadow-sm">
                    <img
                      src={previewUrl}
                      alt="Preview"
                  ...
                  <div className="w-24 h-24 bg-surface-100 rounded-xl flex items-center justify-center mx-auto">
          ...
          <div className="p-6 md:p-10 flex flex-col items-center gap-5 relative z-10">
            <div
              className={`w-20 h-20 rounded-xl flex items-center justify-center transition-transform duration-300 group-hover:scale-110 shadow-sm ${
...
export default function PembayaranPendaftaranTab({
  ...
  if (error) {
    return (
      <div className="bg-red-50 border border-red-200 rounded-xl p-5 md:p-8 text-center max-w-lg mx-auto">
  ...
  // Biaya pendaftaran sesuai ketentuan (Rp 500.000)
  const rawBiaya = data?.tahun_ajaran?.biaya_pendaftaran ? Number(data.tahun_ajaran.biaya_pendaftaran) : 500_000;
  const biayaPendaftaran = rawBiaya >= 500_000 ? rawBiaya : 500_000;
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      {toast && (
        ...
        >
          ...
          <button
            ...
            className="ml-2 hover:bg-white/20 p-1 rounded-xl"
          >
            &times;
          </button>
        </div>
      ...
      <div className="relative overflow-hidden rounded-[2rem] bg-linear-to-br from-primary-700 to-primary-900 border border-primary-600 p-5 md:p-8 text-white shadow-lg app-card">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <button
            onClick={fetchPaymentStatus}
            className="bg-white/10 hover:bg-white/20  border border-white/20 text-white px-4 py-2 rounded-xl flex items-center gap-2 text-sm font-bold transition-all"
          >
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="glass-panel p-5 md:p-8 rounded-[2rem] shadow-sm border border-secondary-200 app-card relative overflow-hidden">
            ...
            {isPaymentPending && (
              <div className="mt-8 p-5 bg-primary-50 border border-pink-200 rounded-xl flex flex-col sm:flex-row items-center sm:items-start gap-4">
                <div className="w-12 h-12 bg-primary-100 rounded-xl flex items-center justify-center shrink-0 whitespace-nowrap shrink-0">
                  <MessageCircle className="w-6 h-6 text-primary-600" />
                </div>
                <div className="text-center sm:text-left flex-1">
                  <h4 className="font-black text-primary-900 mb-1 text-base">
                    Ingin Verifikasi Lebih Cepat?
                  </h4>
                  <p className="text-primary-700 text-sm leading-relaxed">
                    Anda bisa menghubungi Tim Finance di nomor{" "}
                    <a
                      href="https://wa.me/6285883873000?text=Assalamualaikum%20Admin%20Finance%2C%20saya%20ingin%20konfirmasi%20pembayaran%20biaya%20pendaftaran%20santri%20baru."
                      target="_blank"
            ...
            {isPaymentRejected && data.pembayaran?.catatan_verifikasi && (
              <div className="mt-8 p-4 bg-red-50 border border-red-200 rounded-xl flex gap-4">
            ...
            {isStatusOnly && (
              <div className="mt-8 bg-white border border-ink-100 rounded-xl p-5">
          ...
          {!isStatusOnly && canMakePayment && (
            <div className="space-y-8">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                {/* Total Price Tag */}
                <div className="bg-indigo-50 text-indigo-700 px-6 py-3 rounded-xl font-black text-lg border border-indigo-100 shadow-sm flex items-center gap-2">
                  <span>Total:</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-1 gap-6">
                ...
                <div className="relative group bg-white rounded-[2.5rem] p-5 md:p-8 border border-ink-100 shadow-sm transition-all hover:shadow-lg hover:-translate-y-1 overflow-hidden opacity-80 hover:opacity-100 grayscale-[0.5] hover:grayscale-0">
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="mb-6">
                      <div className="w-16 h-16 bg-secondary-100 rounded-xl flex items-center justify-center mb-6 shadow-alert-100/50 text-secondary-600">
                ...
                <div
                  ...
                  className={`relative group bg-white rounded-[2.5rem] p-8 border-2 transition-all cursor-pointer shadow-lg hover:-translate-y-1 hover:shadow-lg ${
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full pt-4">
                    <div className="mb-6">
                      <div className="w-16 h-16 bg-secondary-50 rounded-xl flex items-center justify-center mb-6 shadow-sm text-primary-700">
              ...
              {activePaymentMethod === "manual" && (
                ...
                >
                  <div className="max-w-5xl mx-auto space-y-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-1 gap-6 items-stretch">
                      ...
                      <div className="bg-gradient-to-br from-secondary-50 to-white border border-secondary-100 rounded-[2.5rem] p-5 md:p-8 shadow-sm relative overflow-hidden flex flex-col justify-between">
                        ...
                        <div className="relative z-10">
                          <div className="flex justify-between items-start mb-8">
                            ...
                            <div className="bg-white p-3 rounded-xl shadow-sm border border-secondary-100 flex items-center justify-center text-primary-700">
                              <Building2 className="w-8 h-8" />
                            </div>
                          </div>
                          ...
                          <div className="mb-8">
                            <div className="flex flex-wrap items-center gap-4 mb-2">
                              <h4 className="font-black text-3xl sm:text-2xl md:text-4xl lg:text-5xl text-ink-900 tracking-tight break-all">
                        ...
                        <div className="mt-auto relative z-10">
                          <div className="flex items-start gap-4 bg-white p-5 rounded-xl border border-secondary-100  shadow-sm">
          ...
          {!isStatusOnly && isPaymentCompleted && (
            <div className="bg-primary-50 border border-pink-200 rounded-[2rem] p-5 md:p-8 text-center">
              <div className="w-20 h-20 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-6 animate-in zoom-in duration-300 whitespace-nowrap shrink-0">
                <CheckCircle className="w-10 h-10 text-primary-600" />
              </div>
              <h3 className="text-2xl font-black text-primary-900 mb-2">
                Pembayaran Lunas
              </h3>
              <p className="text-primary-700 max-w-md mx-auto mb-8">
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="px-5 md:px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-bold shadow-lg shadow-primary-600/20 transition-all hover:scale-105 flex items-center gap-2"
                >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface-100 rounded-[2rem] p-6 border border-white/50">
            ...
            <a
              href="https://wa.me/6285883873000?text=Assalamualaikum%20Admin%20Finance%2C%20saya%20mengalami%20kendala%20saat%20melakukan%20pembayaran%20pendaftaran."
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <div>
                ...
                <p className="font-bold text-ink-900 text-sm">0858-8387-3000</p>
              </div>
            </a>
          </div>
        </div>
