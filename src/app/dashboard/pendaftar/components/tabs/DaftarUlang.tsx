    ...
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
              ...
              >
                <div>
                  ...
                  {p.catatan && p.status_pembayaran === "rejected" && (
                    <p className="text-xs text-primary-600 mt-1 font-semibold bg-primary-50 p-2 rounded-lg border border-primary-100">
      ...
      {message && message.type === "success" && (
        <div className="p-5 bg-primary-50 border border-emerald-200 rounded-xl flex flex-col sm:flex-row items-center sm:items-start gap-4 shadow-sm">
          <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center shrink-0 mt-0.5">
      ...
      {isTabLunas ? (
        <div className="bg-primary-50 border border-emerald-200 rounded-2xl p-8 text-center shadow-sm">
