    ...
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
      ...
      {message && message.type === "success" && (
        <div className="p-5 bg-primary-50 border border-pink-200 rounded-xl flex flex-col sm:flex-row items-center sm:items-start gap-4 shadow-sm">
          <div className="w-12 h-12 bg-primary-100 rounded-xl flex items-center justify-center shrink-0 mt-0.5 whitespace-nowrap shrink-0">
      ...
      {isTabLunas ? (
        ...
        <div className="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            {/* Pernyataan */}
            <label className="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-slate-50 cursor-pointer hover:bg-slate-100 transition-colors whitespace-nowrap shrink-0">
              <input
                type="checkbox"
                checked={pernyataan}
