...
export default function DaftarUlangTab() {
  ...
  const expectedUangPangkal = 30000000 - potonganUP;
  const expectedSpp = 3000000 - potonganSPP;
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
      {/* Header */}
      <div className="bg-linear-to-br from-primary-700 to-primary-900 rounded-xl p-5 md:p-8 text-white shadow-lg relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 gap-3">
          ...
          >
            {totalDaftarUlangPaid >= expectedUangPangkal && (
              <span className="absolute top-2 right-2 bg-primary-500 text-white text-[9px] font-black px-1.5 py-0.5 rounded-full">
                ✓ LUNAS
              </span>
            )}
            <Building2
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm flex flex-col justify-between">
          ...
          <span className="text-2xl font-black text-primary-600 mt-2">
              ...
              >
                <div>
                  ...
                  {p.catatan && p.status_pembayaran === "rejected" && (
                    <p className="text-xs text-primary-600 mt-1 font-semibold bg-primary-50 p-2 rounded-xl border border-primary-100">
      ...
      <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl border border-primary-100 shadow-sm space-y-4">
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="flex justify-between border-t border-slate-100 pt-1 mt-1">
              ...
              <span className="font-bold text-ink-800">Rp 3.000.000</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-primary-50 p-6 rounded-xl border border-primary-100 flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 gap-2 mb-4 bg-white p-1 rounded-xl shadow-sm border border-primary-100">
              <button
                onClick={() => setPaymentMethod("transfer")}
                className={`py-2 px-2 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 ${
              ...
              <div className="py-2 px-2 rounded-xl text-xs font-bold flex flex-col items-center justify-center gap-0.5 bg-slate-50 border border-slate-100 text-slate-400 opacity-70 cursor-not-allowed">
            ...
            {paymentMethod === "transfer" && (
              <div className="mb-4 p-3 bg-white border border-primary-100 rounded-xl">
            ...
            <ul className="text-sm text-primary-700 space-y-1.5 list-disc list-inside font-medium mb-4">
              ...
              <li className="text-primary-700 font-bold">
          ...
          <div className="pt-4 border-t border-primary-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-2 mt-2">
              <a
                href="https://wa.me/6285883873000?text=Assalamualaikum%20Admin%20Finance%2C%20saya%20wali%20dari%20calon%20santri%20ingin%20berkonsultasi%2Fmengajukan%20keringanan%20terkait%20biaya%20Daftar%20Ulang."
                target="_blank"
                rel="noreferrer"
      ...
      {message && message.type === "success" && (
        <div className="p-5 bg-primary-50 border border-pink-200 rounded-xl flex flex-col sm:flex-row items-center sm:items-start gap-4 shadow-sm">
          <div className="w-12 h-12 bg-primary-100 rounded-xl flex items-center justify-center shrink-0 mt-0.5 whitespace-nowrap inline-block shrink-0">
      ...
      {isTabLunas ? (
        ...
        <div className="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                totalPaid < halfTagihan && (
                  <div className="mt-4 p-4 bg-secondary-50 border border-secondary-200 rounded-xl space-y-3">
                    ...
                    <textarea
                      ...
                      className="w-full p-3 text-xs border border-secondary-300 rounded-xl focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500 transition-all bg-white font-medium min-h-[80px]"
                      required
                    />
                  </div>
                )}
            ...
            {/* Pernyataan */}
            <label className="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-slate-50 cursor-pointer hover:bg-slate-100 transition-colors whitespace-nowrap inline-block shrink-0">
              <input
                type="checkbox"
                checked={pernyataan}
            ...
            <button
              ...
              className="w-full py-4 bg-gold-400 hover:bg-gold-300 text-primary-950 font-black rounded-xl shadow-lg shadow-gold-400/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 border border-gold-500"
            >
              {submitting ? (
