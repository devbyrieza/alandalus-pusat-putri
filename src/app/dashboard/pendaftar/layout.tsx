...
import {
  ...
  formatStatusDisplay,
  getNextStep,
  STATUS_ORDER } from "@/lib/access-control";
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (!sessionData.pendaftar_id) {
          console.warn("<AlertTriangle size={20} className='inline-block mr-2' /> [Layout] No pendaftar_id found in session");
        ...
        console.log(`<CheckCircle2 size={20} className="inline-block mr-2" /> [Layout] Current Status: ${currentStatus}`);
      ...
      <div className="min-h-screen bg-surface-50 font-sans selection:bg-primary-100 selection:text-primary-900 w-full">
        ...
        <div className="flex relative">
          ...
          >
            ...
            />
            <div ref={mobileSidebarRef} className={`absolute top-0 left-0 bottom-0 w-80 bg-white shadow-lg transition-transform duration-300 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
            >
                ...
                <div className="mx-4 md:mx-6 lg:mx-5 mt-4 mb-0">
                  <div className="flex items-center gap-3 bg-orange-50 border border-orange-300 rounded-xl px-4 py-3 shadow-sm">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-black text-orange-900"><AlertTriangle size={20} className="inline-block mr-2" /> Data Ukuran Seragam Belum Diisi!</p>
