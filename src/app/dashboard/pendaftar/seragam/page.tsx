...
export default function SeragamPage() {
  ...
  if (!isAuthorized) {
    return (
      <div className="max-w-3xl mx-auto mt-8 bg-white p-10 rounded-xl shadow-sm border border-red-100 flex flex-col items-center justify-center text-center">
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-white p-6 rounded-xl shadow-sm border border-ink-100 flex items-start gap-4 relative overflow-hidden">
        ...
        <div className="w-12 h-12 bg-primary-100 text-primary-700 rounded-xl flex items-center justify-center flex-shrink-0 relative z-10 whitespace-nowrap inline-block shrink-0">
          <Shirt className="w-6 h-6" />
        </div>
        <div className="relative z-10">
          <h1 className="text-xl font-black text-primary-950">Pendataan Ukuran Seragam</h1>
          <p className="text-sm font-medium text-ink-500 mt-1">
            Silakan pilih ukuran baju dan celana santri sesuai dengan panduan ukuran di bawah ini. Pastikan ukuran yang dipilih sudah benar.
          </p>
        </div>
      </div>
