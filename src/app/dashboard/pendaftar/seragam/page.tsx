  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-white p-6 rounded-xl shadow-sm border border-ink-100 flex items-start gap-4 relative overflow-hidden">
        ...
        <div className="w-12 h-12 bg-primary-100 text-primary-700 rounded-xl flex items-center justify-center flex-shrink-0 relative z-10 whitespace-nowrap shrink-0">
