...
> = {
  ...
  accepted: {
    ...
    icon: Trophy,
    message:
      "Alhamdulillah! Selamat, putra/putri Anda diterima di Pesantren Islam Internasional Al-Andalus Putri!" },
  payment_rejected: {
    ...
    <main className="min-h-screen bg-white relative overflow-hidden pb-24">
      ...
      <Container className="pt-16 md:pt-24 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          {/* RIGHT SIDE: SIDEBAR */}
          <aside className="lg:col-span-4 space-y-10 overscroll-contain">
            {/* REG CARD */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
