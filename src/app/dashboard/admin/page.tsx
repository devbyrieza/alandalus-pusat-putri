        ...
        <div className="mb-6 lg:mb-8">
          ...
          <div className="flex items-baseline justify-between gap-2 flex-wrap">
            <div className="flex items-baseline gap-2">
              <h3 className={`text-3xl sm:text-4xl lg:text-2xl md:text-4xl font-black tracking-tighter ${
  ...
  return (
    <div className="relative max-w-[1400px] mx-auto space-y-6 sm:space-y-8 pb-20 px-1">
      ...
      <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight">
            <span className="gradient-text-pink">Dashboard Admin {BRANDING.schoolShortName}</span>
          </h1>
      ...
      <div className="bg-linear-to-br from-primary-800 via-primary-700 to-primary-950 rounded-[2.5rem] lg:rounded-[3rem] p-6 sm:p-5 md:p-8 lg:p-6 text-white relative overflow-hidden shadow-[0_32px_64px_-16px_rgba(159,18,57,0.4)] border border-white/10">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          <div className="max-w-xl w-full">
            ...
            <h2 className="text-3xl sm:text-2xl md:text-4xl lg:text-3xl font-black mb-4 sm:mb-6 tracking-tighter leading-tight text-white drop-shadow-sm">
              Pantau <span className="text-secondary-300">Pendaftaran</span>
            </h2>
            <div className="flex items-center gap-8 sm:gap-12 mt-8 lg:mt-12">
              <div>
                <span className="text-3xl sm:text-3xl md:text-2xl lg:text-5xl font-black text-white drop-shadow-md">{stats.total_pendaftar}</span>
              ...
              <div>
                <span className="text-3xl sm:text-3xl md:text-2xl lg:text-5xl font-black text-secondary-300 drop-shadow-md">{stats.sudah_bayar}</span>
      ...
      {(isAdminSuper || isAdminBerkas || isAdminKeuangan) && (
        ...
        <div className="bg-linear-to-br from-primary-800 to-primary-950 rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] p-5 sm:p-5 md:p-8 lg:p-6 text-white relative overflow-hidden group shadow-[0_16px_40px_-12px_rgba(159,18,57,0.4)] border border-white/5">
