          ...
          <form onSubmit={handleScan}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#ddc192] focus:border-transparent outline-none transition"
            ...
            {!santriData && (
              <button 
                type="submit" 
                className="w-full bg-[#550000] text-white py-3 rounded-xl font-medium hover:bg-red-900 transition disabled:opacity-50"
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 opacity-100 transition-opacity">
          ...
          {santriData ? (
            <div className="space-y-4">
              <div className="bg-[#fdfbf7] p-4 rounded-xl border border-[#ddc192]">
              ...
              <form onSubmit={handleBayar}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-2xl font-bold border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#550000] focus:border-transparent outline-none transition"
                    placeholder="0"
                    required
                    min="1"
                  />
                ...
                <div className="flex space-x-3">
                  ...
                  <button 
                    type="submit" 
                    className="flex-[2] bg-[#ddc192] text-[#550000] py-3 rounded-xl font-bold hover:brightness-95 transition disabled:opacity-50"
