...
export default function AdminUploadPaymentModal({
  ...
  return (
    <div onWheel={(e) => e.stopPropagation()} 
      role="dialog" aria-modal="true" data-modal="true" className="fixed inset-0 bg-stone-900/80  z-[100] flex justify-center items-start pt-10 md:pt-16 px-4 overflow-y-auto overscroll-contain custom-scrollbar"
      onClick={onClose}
    >
      <div 
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-4 py-2.5 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-xl font-bold transition-colors flex items-center gap-2 border border-stone-200 whitespace-nowrap shrink-0"
                    >
