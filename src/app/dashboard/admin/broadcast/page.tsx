    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-clay-lg p-5 md:p-8 border border-white/40 overflow-hidden relative">
        ...
        <div className="relative flex items-center gap-6">
          <div className="p-4 bg-gradient-to-br from-primary-600 to-rose-600 rounded-2xl shadow-lg shadow-primary-600/20">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-2xl shadow-clay-md border border-white/40 p-6 space-y-6 sticky top-28">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Contoh: Tim PSB Al-Andalus Putri"
                  className="w-full bg-secondary-50 border-none rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary-600/10 outline-none font-medium"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-br from-primary-600 to-rose-600 text-white rounded-2xl font-black shadow-lg shadow-primary-600/20 hover:shadow-primary-600/30 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:shadow-none"
            >
              {sending ? (
                <>
