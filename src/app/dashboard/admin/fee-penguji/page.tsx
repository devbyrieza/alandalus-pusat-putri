...
export default function RekapFeePengujiPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-xl border border-ink-100 shadow-sm">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <Button
            onClick={fetchData}
            variant="outline"
            className="rounded-xl border-ink-200 text-ink-600 font-bold hover:bg-ink-50 h-11"
          >
          ...
          <Button
            ...
            className="rounded-xl bg-primary-600 hover:bg-primary-700 text-white font-black shadow-lg shadow-primary-600/20 h-11"
          >
        ...
        <div className="p-6 border-b border-ink-100 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="relative w-full md:max-w-md">
            ...
            <input
              ...
              className="w-full bg-ink-50 border border-ink-100 rounded-xl pl-11 pr-4 py-3 text-sm font-bold text-ink-900 focus:ring-2 focus:ring-primary-600/10 outline-none"
            />
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-ink-50/50 border-b border-ink-100">
                  ...
                  <th className="px-6 py-4 text-xs font-black text-primary-600 uppercase tracking-wider text-right bg-primary-50/30">
                    Fee (Rp)
                  </th>
                </tr>
              </thead>
                ...
                {filteredData.length === 0 ? (
                  ...
                  filteredData.map((item) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right font-black text-primary-700 bg-primary-50/30 text-base">
