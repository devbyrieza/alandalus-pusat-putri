  ...
  return (
    <div className="space-y-6">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col">
                            ...
                            <span className="text-xs text-ink-500 font-bold mt-0.5 font-mono">
                              {item.nomor_pendaftaran} • {item.jenjang === "IL" ? "IL" : "SMP IT"}
                            </span>
                          </div>
                        </td>
      ...
      {editModalOpen && editingItem && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-50 flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-4 bg-ink-950/50  overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
