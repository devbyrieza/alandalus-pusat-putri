  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
          ...
          <div>
            ...
            >
              ...
              <option value="MTs">SMP IT (Sekolah Menengah Pertama Islam Terpadu)</option>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-wider px-2 py-0.5 bg-primary-100 text-primary-700 rounded-full whitespace-nowrap inline-block shrink-0">
                ...
                <tbody className="divide-y divide-stone-200">
                  {pendaftar.map((item) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className="px-3 py-1 bg-primary-100 text-primary-700 rounded-full text-xs font-bold whitespace-nowrap inline-block shrink-0">
                          {item.jenjang === "IL" ? "IL" : "SMP IT"}
                        </span>
                      </td>
                      <td className="px-4 py-3">
      ...
      {isAnnouncementModalOpen && selectedPendaftar && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-50 flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center bg-black/50  p-4 overflow-y-auto overscroll-contain custom-scrollbar">
            ...
            <form onSubmit={handleSubmitAnnouncement} className="p-6 space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4 mt-4 border-t border-stone-100">
                <button
                  type="button"
                  onClick={() => setIsAnnouncementModalOpen(false)}
                  className="px-6 py-2.5 font-bold text-stone-500 hover:bg-stone-100 rounded-xl transition-colors whitespace-nowrap inline-block shrink-0"
      ...
      {isDeleteModalOpen && deletingPendaftar && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-50 flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center bg-black/50  p-4 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
