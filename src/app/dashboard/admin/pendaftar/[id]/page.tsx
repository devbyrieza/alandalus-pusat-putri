        ...
        const { value: formValues } = await Swal.fire({
          ...
          html: `
            <div class="text-left text-sm mb-4 text-stone-600 bg-amber-50 p-3 rounded-xl border border-amber-200">
              ...
              Contoh: Jika Uang Pangkal normal Rp 30.000.000, dan wali santri hanya sanggup bayar Rp 25.000.000, berarti <b>potongannya adalah Rp 5.000.000</b>. <br/>Ketik: <b>1500000</b>.
            </div>
