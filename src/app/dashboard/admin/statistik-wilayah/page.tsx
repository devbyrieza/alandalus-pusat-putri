...
export default async function StatistikWilayahPage(props: {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="bg-linear-to-br from-primary-600 to-primary-900 rounded-xl p-5 md:p-8 text-white relative overflow-hidden shadow-lg shadow-primary-900/20">
        ...
        <div className="flex items-center gap-6 relative z-10">
          <div className="w-16 h-16 bg-white/20  rounded-xl flex items-center justify-center text-secondary-300 shadow-inner">
