...
export default function UserManagementPage() {
  ...
  return (
    <div className="space-y-10 pb-16 animate-in fade-in duration-700">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-2xl sm:text-3xl lg:text-5xl font-black font-display tracking-tight mt-2 italic shadow-lg shadow-emerald-900/20 text-white">
                Manajemen Admin
              </h1>
            </div>
          </div>
      ...
      {/* User List Dashboard */}
      <div className="bg-white rounded-4xl border border-secondary-100 shadow-lg shadow-emerald-900/20 overflow-hidden app-card">
        <div className="p-5 md:p-8 border-b border-stone-50 flex flex-col md:flex-row justify-between items-center gap-6 bg-secondary-50/10">
          <div className="relative w-full md:w-[28rem]">
            ...
            <input
              ...
              className="w-full pl-16 pr-8 py-5 bg-white border-2 border-secondary-100 rounded-[2.5rem] focus:outline-none focus:border-primary-500 font-bold shadow-lg shadow-emerald-900/20 placeholder:text-stone-300"
            />
          </div>
                  ...
                  >
                    <td className="p-5 md:p-8">
                      <div className="flex items-center gap-5">
                        <div className="w-12 h-12 rounded-xl bg-primary-100 flex items-center justify-center text-primary-700 font-black text-xs border-2 border-white shadow-lg shadow-emerald-900/20">
                    ...
                    <td className="p-5 md:p-8 text-center">
                      <div className="flex flex-wrap justify-center gap-2">
                        <span className="px-4 py-1.5 bg-primary-50 text-primary-700 text-[10px] font-black rounded-xl border border-primary-100 uppercase tracking-widest shadow-lg shadow-emerald-900/20">
                        ...
                        {user.secondary_roles &&
                          user.secondary_roles
                            ...
                            .map((r, i) => (
                              <span
                                key={i}
                                className="px-4 py-1.5 bg-stone-100 text-stone-600 text-[10px] font-black rounded-xl border border-stone-200 uppercase tracking-widest shadow-lg shadow-emerald-900/20"
                              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-5 md:gap-8">
                <div className="col-span-1 md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-xl transition-all"
                  />
                </div>
                <div className="col-span-1 md:col-span-2">
                  <label className="block text-[10px] font-black uppercase text-stone-500 mb-3 tracking-widest">
                ...
                <div>
                  ...
                  <div className="relative group/pass">
                    <input
                      ...
                      className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-xl transition-all pr-16"
                      placeholder={
                ...
                <div className="col-span-1 md:col-span-2">
                  ...
                  <select
                    ...
                    className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-xl transition-all cursor-pointer"
                  >
