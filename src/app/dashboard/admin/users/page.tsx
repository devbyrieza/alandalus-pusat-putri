...
export default function UserManagementPage() {
  ...
  return (
    <div className="space-y-10 pb-16 animate-in fade-in duration-700">
      {/* Admin Banner */}
      <div className="relative overflow-hidden rounded-4xl bg-linear-to-br from-primary-700 to-primary-900 text-white p-6 md:p-10 shadow-lg app-card border border-primary-600">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="flex items-center gap-6">
            <div className="w-20 h-20 rounded-xl bg-white/10 flex items-center justify-center border border-white/20 text-secondary-300">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-2xl sm:text-3xl lg:text-5xl font-black font-display tracking-tight mt-2 italic shadow-lg shadow-pink-900/20 text-white">
                Manajemen Admin
              </h1>
            </div>
          </div>
          <button
            ...
            className="bg-secondary-400 hover:bg-secondary-300 text-primary-950 px-6 md:px-10 py-5 rounded-xl font-black uppercase text-xs shadow-lg transition-all flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
          >
      ...
      {/* User List Dashboard */}
      <div className="bg-white rounded-4xl border border-secondary-100 shadow-lg shadow-pink-900/20 overflow-hidden app-card">
        <div className="p-5 md:p-8 border-b border-stone-50 flex flex-col md:flex-row justify-between items-center gap-6 bg-secondary-50/10">
          <div className="relative w-full md:w-[28rem]">
            ...
            <input
              ...
              className="w-full pl-16 pr-8 py-5 bg-white border-2 border-secondary-100 rounded-[2.5rem] focus:outline-none focus:border-primary-500 font-bold shadow-lg shadow-pink-900/20 placeholder:text-stone-300"
            />
          </div>
                  ...
                  >
                    <td className="p-5 md:p-8">
                      <div className="flex items-center gap-5">
                        <div className="w-12 h-12 rounded-xl bg-primary-100 flex items-center justify-center text-primary-700 font-black text-xs border-2 border-white shadow-lg shadow-pink-900/20 whitespace-nowrap inline-block shrink-0">
                    ...
                    <td className="p-5 md:p-8 text-center">
                      <div className="flex flex-wrap justify-center gap-2">
                        <span className="px-4 py-1.5 bg-primary-50 text-primary-700 text-[10px] font-black rounded-xl border border-primary-100 uppercase tracking-widest shadow-lg shadow-pink-900/20">
                        ...
                        {user.secondary_roles &&
                          user.secondary_roles
                            ...
                            .map((r, i) => (
                              <span
                                key={i}
                                className="px-4 py-1.5 bg-stone-100 text-stone-600 text-[10px] font-black rounded-xl border border-stone-200 uppercase tracking-widest shadow-lg shadow-pink-900/20 whitespace-nowrap inline-block shrink-0"
                              >
      ...
      {isModalOpen && (
        <div
          ...
          className="fixed inset-0 z-50 flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-6 bg-primary-950/40  animate-in fade-in duration-300 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar"
        >
          <div className="bg-white rounded-[3rem] shadow-lg w-full max-w-3xl flex flex-col max-h-[90vh] animate-in zoom-in duration-300 border border-white/20">
            ...
            <form onSubmit={handleSubmit} className="p-6 md:p-12 space-y-8 overflow-y-auto custom-scrollbar overscroll-contain">
              <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-5 md:gap-8">
                <div className="col-span-1 md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-xl transition-all whitespace-nowrap inline-block shrink-0"
                  />
                </div>
                <div className="col-span-1 md:col-span-2">
                  <label className="block text-[10px] font-black uppercase text-stone-500 mb-3 tracking-widest">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 md:px-5 py-4 bg-primary-50 border-2 border-primary-100 text-primary-900 rounded-xl font-black text-xs uppercase tracking-widest cursor-pointer"
                  >
                    {ROLE_OPTIONS.map((o) => (
                ...
                <div>
                  ...
                  <div className="relative group/pass">
                    <input
                      ...
                      className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-xl transition-all pr-16 whitespace-nowrap inline-block shrink-0"
                      placeholder={
                ...
                <div className="col-span-1 md:col-span-2">
                  ...
                  <select
                    ...
                    className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-xl transition-all cursor-pointer whitespace-nowrap inline-block shrink-0"
                  >
              ...
              <div className="pt-10">
                <button
                  type="submit"
                  className="w-full py-6 bg-primary-950 text-white font-black uppercase text-xs tracking-widest rounded-xl shadow-lg hover:bg-primary-800 hover:scale-[1.02] active:scale-95 transition-all shadow-primary-900/30"
                >
