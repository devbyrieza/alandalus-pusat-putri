  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl p-6 border border-ink-100 shadow-sm flex items-center gap-4">
      ...
      {/* Filters */}
      <div className="bg-white p-4 rounded-xl border border-ink-100 shadow-sm flex flex-col md:flex-row gap-4 justify-between items-center">
        <div className="relative w-full md:w-96">
          <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-ink-400" />
          <input
            type="text"
            placeholder="Cari nama penguji..."
            className="w-full pl-12 pr-4 py-3 bg-ink-50 border-none rounded-xl focus:ring-2 focus:ring-primary-500 text-sm font-bold text-primary-950"
            value={searchTerm}
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                {stat.pendingStudents.map((student) => (
                                  <div key={student.jadwalId} className="bg-white p-3 rounded-xl border border-ink-200 shadow-sm flex flex-col">
