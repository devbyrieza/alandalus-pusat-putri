...
export default function JadwalUjianPage() {
  ...
  const [newSession, setNewSession] = useState({
    ...
    end_time: "",
    quota: 10,
    location: "Pesantren Islam Internasional Al-Andalus Putri",
    notes: "" });
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <button
              ...
              className="flex items-center gap-3 px-6 py-3 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-xl font-black border border-indigo-200 transition-all whitespace-nowrap shrink-0"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl p-6 border border-indigo-100 shadow-clay-md flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-xs mt-2 text-primary-600 font-bold flex items-center gap-1">
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        ...
                        <span className="flex items-center gap-1.5 text-xs font-bold text-primary-600 uppercase tracking-wider">
                  ...
                  <div className="flex items-center gap-3">
                    {selectedPendaftarId ? (
                      <button
                        ...
                        className="w-full md:w-auto px-6 py-3 bg-gradient-to-br from-primary-600 to-primary-600 text-white rounded-xl font-black shadow-lg shadow-primary-600/20 hover:scale-105 transition-all flex items-center justify-center gap-2"
                      >
                        {assigning ? (
              ...
              <div className="p-5 md:p-8 space-y-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-black text-ink-900">
                    Buat Sesi <span className="text-primary-600">Baru</span>
                  </h2>
                  <button
                    type="button"
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-secondary-50 border-none rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary-500/10 outline-none font-bold"
                    />
                  </div>
                  ...
                  <div className="bg-primary-50 rounded-xl p-4 border border-primary-100 flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-primary-900 uppercase tracking-wider mb-1">
                        Informasi Otomatis
                      </p>
