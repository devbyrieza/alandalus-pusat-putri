      ...
      <main className="flex-1 pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h1 className="text-4xl md:text-2xl sm:text-3xl lg:text-5xl font-black text-slate-900 mb-6 tracking-tight">Berita & Kegiatan</h1>
            ...
            {[
              ...
              <button 
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold transition-all
                  ${activeTab === tab.id 
                    ? (IS_PUTRA ? "bg-primary-600 text-white shadow-md" : "bg-emerald-600 text-white shadow-md") 
              ...
              <div key={i} className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden group hover:shadow-md transition-all">
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 text-xs text-slate-500 mb-3">
                    <Calendar className={`w-3.5 h-3.5 ${IS_PUTRA ? "text-primary-500" : "text-emerald-500"}`} />
                    {item.date}
                  </div>
