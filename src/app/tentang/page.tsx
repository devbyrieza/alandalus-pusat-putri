  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="section-std pb-0 relative overflow-hidden py-16">
        <div className="absolute top-0 right-0 w-full max-w-[500px] h-[500px] bg-primary-100/50 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
        ...
        <Container className="relative z-10 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-50 border border-emerald-200 text-primary-800 text-xs font-bold uppercase tracking-wider mb-6 shadow-sm"
          >
          ...
          <motion.h1
            ...
            className="text-4xl md:text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-tight max-w-4xl mx-auto mb-6"
          >
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950/70 via-transparent to-transparent flex items-end p-8 text-left">
              <div className="text-white space-y-1">
                ...
                <p className="text-primary-300 text-sm font-medium">{BRANDING.address}</p>
              </div>
            </div>
          </motion.div>
        </Container>
      ...
      {/* 3. CTA FOOTER */}
      <section className="py-16 bg-gradient-to-r from-primary-900 to-teal-900 text-white text-center">
        <Container>
          <div className="max-w-3xl mx-auto space-y-6">
            <h2 className="text-3xl font-bold">Bergabunglah Bersama Keluarga Besar {BRANDING.schoolShortName}</h2>
            <p className="text-primary-100 text-lg">Pendaftaran Santri Baru Tahun Ajaran 2027-2028 Telah Dibuka. Kuota Terbatas!</p>
            <div className="pt-2">
              <Link
                href="/ppdb"
