      ...
      <main className="flex-1 pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className={`p-8 rounded-3xl shadow-sm border ${IS_PUTRA ? "bg-primary-50 border-primary-100" : "bg-sky-50 border-sky-100"}`}>
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 bg-white shadow-sm ${IS_PUTRA ? "text-primary-600" : "text-sky-600"}`}>
                <Target className="w-7 h-7" />
              </div>
              <h2 className="text-2xl font-black text-slate-900 mb-4">Visi Kami</h2>
              <p className={`text-xl font-bold italic leading-relaxed ${IS_PUTRA ? "text-primary-800" : "text-sky-800"}`}>
                &quot;Kaderisasi Umat Rabbani, Cendekia, dan Mandiri.&quot;
              </p>
            </div>

            <div className="p-8 rounded-3xl shadow-sm border bg-white border-slate-100">
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 bg-slate-100 shadow-sm ${IS_PUTRA ? "text-primary-600" : "text-sky-600"}`}>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex gap-4 items-start">
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center text-white shrink-0 mt-0.5 ${IS_PUTRA ? "bg-primary-500" : "bg-sky-500"}`}>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed text-lg">
                <p>
                  Pesantren Al-Andalus Putri berdiri pada tahun <strong>2015</strong>.
                </p>
                <p>
                  Berlokasi di wilayah Jonggol, Bogor, kampus kami berdiri di atas lahan seluas 
                  <strong> 2.2 hektar</strong>.
                </p>
                <p>
              ...
              <div className="mt-8 flex gap-4">
                <div className="flex items-center gap-2 text-slate-700 bg-white px-4 py-2 rounded-xl shadow-sm border border-slate-100">
                  <ShieldCheck className={`w-5 h-5 ${IS_PUTRA ? "text-primary-500" : "text-sky-500"}`} />
            ...
            <div className="bg-slate-100 rounded-3xl aspect-square flex items-center justify-center relative overflow-hidden">
               ...
               <div className={`absolute inset-0 opacity-20 blur-3xl ${IS_PUTRA ? "bg-primary-400" : "bg-sky-400"}`} />
            </div>
          </div>
