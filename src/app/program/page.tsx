        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-24 bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100 text-center">
             ...
             <div className="flex flex-wrap justify-center gap-3">
               {["Arabic Club", "English Club", "Biology Club", "Chemistry Club", "Science Club", "Math Club", "Tahfidz Club", "Desain Grafis", "Tata Boga", "Tata Busana", "Tata Rias", "Panahan", "Wing Chun", "Basket", "Badminton", "Fotografi"].map(e => <span key={e} className="px-4 py-2 bg-slate-50 border border-slate-200 rounded-full text-sm font-semibold text-slate-700">{e}</span>)}
             </div>
          </div>
        </div>
      </main>
