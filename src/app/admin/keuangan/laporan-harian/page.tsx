    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto h-full flex flex-col">
        ...
        <div className="flex gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="bg-white border border-slate-200 font-bold text-slate-700 rounded-xl py-2 pl-10 pr-4 focus:outline-none focus:border-primary-500"
            />
          </div>
          <button 
            onClick={handlePrint}
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 print:shadow-none print:border-none print:p-0">
        ...
        <div className="text-center border-b-2 border-slate-900 pb-6 mb-6">
          ...
          <p className="text-sm font-bold mt-2 bg-slate-100 inline-block px-4 py-1 rounded-full whitespace-nowrap inline-block shrink-0">
          ...
          <div className="bg-primary-50 p-6 rounded-xl border border-primary-100">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center border-b border-primary-200 pb-2">
                <span className="font-medium text-primary-800">Jumlah Transaksi (Struk)</span>
                <span className="font-black text-primary-900">{ringkasan.totalTransaksi} Trx</span>
              </div>
              <div className="flex justify-between items-center border-b border-primary-200 pb-2">
                <span className="font-medium text-primary-800">Total Omzet Kantin Hari Ini</span>
                <span className="font-black text-primary-900 text-xl">Rp {ringkasan.totalNominal.toLocaleString('id-ID')}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="w-full overflow-x-auto rounded-xl border border-slate-200 shadow-sm"><table className="w-full text-left text-sm border-collapse">
            ...
            <tfoot>
              <tr>
                ...
                <td className="p-4 text-right font-black text-primary-700 text-xl">Rp {ringkasan.totalNominal.toLocaleString('id-ID')}</td>
              </tr>
            </tfoot>
          </table></div>
        </div>
