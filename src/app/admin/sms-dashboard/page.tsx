    ...
    return (
      <div className="min-h-screen bg-slate-50/50 flex items-center justify-center p-6 md:p-10">
        <div className="text-center p-8 bg-white rounded-3xl shadow-xl border border-slate-100 max-w-sm w-full">
          <RefreshCw className="w-10 h-10 animate-spin mx-auto text-rose-600 mb-4" />
    ...
    <div className="min-h-screen bg-slate-50/50 p-6 md:p-10">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-6 md:p-10 border border-slate-100 relative overflow-hidden">
          {/* Decorative Top Bar */}
          <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-rose-500 via-teal-500 to-amber-500" />

          {/* Header */}
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-rose-50 text-rose-600 border border-rose-100 flex items-center justify-center shadow-xs">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-3 bg-rose-600 hover:bg-rose-700 text-white font-bold rounded-2xl shadow-lg shadow-rose-600/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
          ...
          {/* Instructions Banner */}
          <div className="bg-rose-50/60 border border-rose-100 rounded-3xl p-6 mb-8">
            <h3 className="font-black text-rose-900 text-base mb-3 flex items-center gap-2">
            ...
            <ol className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm font-medium text-rose-800">
              ...
              <li className="flex items-start gap-2.5 bg-white/80 p-3 rounded-2xl border border-rose-100/50">
                <span className="w-6 h-6 rounded-full bg-rose-600 text-white font-bold text-xs flex items-center justify-center shrink-0">2</span>
                <span>Kirim SMS dari HP Admin ke nomor tujuan</span>
              </li>
              <li className="flex items-start gap-2.5 bg-white/80 p-3 rounded-2xl border border-rose-100/50">
                <span className="w-6 h-6 rounded-full bg-rose-600 text-white font-bold text-xs flex items-center justify-center shrink-0">3</span>
                <span>Format: "PPDB AL-IMAM: Kode OTP: [OTP] untuk [NAMA]"</span>
              </li>
              <li className="flex items-start gap-2.5 bg-white/80 p-3 rounded-2xl border border-rose-100/50">
                <span className="w-6 h-6 rounded-full bg-rose-600 text-white font-bold text-xs flex items-center justify-center shrink-0">4</span>
          ...
          {pendingSMS.length === 0 ? (
            <div className="text-center py-16 px-4 bg-slate-50/50 rounded-3xl border border-dashed border-slate-200">
              <div className="w-16 h-16 rounded-full bg-rose-100 text-rose-600 flex items-center justify-center mx-auto mb-4 border border-emerald-200">
                ...
                >
                  ...
                  <div className="bg-slate-900 text-slate-100 rounded-2xl p-5 shadow-inner">
                    <p className="text-xs text-slate-400 font-bold uppercase tracking-wider mb-2 flex items-center gap-1.5">
                      <MessageSquare className="w-3.5 h-3.5 text-rose-400" /> Pratinjau Pesan:
                    </p>
...
Hubungi 0851-1152-4441 jika ada masalah.`}
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-2">
                    <button
                      ...
                      className="flex-1 py-3.5 px-6 bg-rose-600 hover:bg-rose-700 text-white font-bold rounded-2xl shadow-md shadow-rose-600/20 transition-all flex items-center justify-center gap-2"
                    >
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-6 md:p-8 border border-slate-100">
          <h3 className="font-black text-slate-900 text-lg mb-6 flex items-center gap-2">
            <BarChart3 className="w-5 h-5 text-rose-600" /> Status Layanan & Integrasi
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-rose-50/50 border border-rose-100 p-5 rounded-2xl">
              <p className="text-xs text-rose-700 font-bold uppercase tracking-wider mb-1">SMS Service</p>
              <p className="text-xl font-black text-rose-950 flex items-center gap-1.5">
                <Sparkles className="w-4 h-4 text-rose-600" /> Simulation
              </p>
            </div>
