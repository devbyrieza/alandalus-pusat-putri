...
const DEFAULT_APP_URL = process.env.NEXT_PUBLIC_APP_URL || BRANDING.websiteUrl || "https://pesantren-alandalus-putri.com";
...
Berdasarkan hasil seleksi SPMB Pesantren Islam Internasional Al-Andalus Putri, kami informasikan bahwa Anda dinyatakan *CADANGAN*.
...
Berdasarkan hasil seleksi SPMB Pesantren Islam Internasional Al-Andalus Putri, kami informasikan bahwa Anda *BELUM DITERIMA* pada periode ini.
