...
export const generateSuratKelulusan = async (data: PendaftarPdfData) => {
  ...
  if (statusText === "LULUS / DITERIMA") {
    const daftarUlangInfo =
      "Pembayaran daftar ulang harus segera dibayarkan minimal 50% paling lambat sepekan setelah pengumuman hasil. Bagi yang membutuhkan keringanan, silakan menghubungi bagian Finance di 0858-8387-3000.";
    doc.setFont("helvetica", "bold");
    doc.setFontSize(10);
    doc.text(
