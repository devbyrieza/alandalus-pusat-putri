...
const FACILITIES = [
  ...
  { name: "Klinik Kesehatan & Dokter", icon: HeartPulse, color: "red" },
  { name: "Restorasi & Air Minum RO", icon: Coffee, color: "orange" },
  { name: "CCTV Area Strategis", icon: Monitor, color: "indigo" },
  { name: "Perlengkapan Keasramaan & Laundry", icon: ShoppingCart, color: "amber" },
  { name: "Fasilitas Olahraga Lengkap", icon: Dumbbell, color: "gold" },
] as const;
        ...
        >
          {FACILITIES.map((facility, idx) => (
            <motion.div
              ...
              className="group flex items-center gap-3.5 p-3.5 rounded-xl bg-white border border-secondary-100 hover:border-primary-100 shadow-premium-sm hover:shadow-premium-md transition-all duration-300 ease-out cursor-default"
            >
              <div
