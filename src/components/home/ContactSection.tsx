      ...
      <Container>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            ...
            {/* ── Cards Grid ── */}
            <div className="lg:w-[55%] grid sm:grid-cols-1 gap-3 sm:gap-4 w-full">
              {CONTACT_INFO.map((item, idx) => (
                <div
                  key={idx}
                  className={`bg-white p-6 rounded-xl border border-secondary-100 shadow-premium-sm hover:shadow-premium-md flex flex-col items-start group transition-all duration-400 ${idx === 0 ? "sm:col-span-2" : ""}`}
                >
                  <div
