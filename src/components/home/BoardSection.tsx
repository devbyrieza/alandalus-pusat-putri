...
function MemberCard({
  ...
  return (
    <motion.div
      ...
      className="group flex items-center gap-5 p-4 md:p-5 bg-white rounded-xl border border-secondary-100 shadow-premium-sm hover:shadow-premium-md hover:border-primary-200 transition-all duration-400"
    >
      {/* Avatar */}
