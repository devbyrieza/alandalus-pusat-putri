...
const STATS: Stat[] = [
  {
    ...
    suffix: "",
    sublabel: "Fakta AIIS",
    description: "Pengalaman pendidikan pesantren modern" },
  {
    id: "area",
    label: "Luas Area",
    value: 2,
    ...
    description: "Fasilitas lengkap untuk kenyamanan belajar" },
  {
    ...
    color: "pink",
    suffix: " Lembaga",
    sublabel: "Diknas A, Muadalah Madinah & Al-Azhar",
    description: "Pengakuan kualitas pendidikan" },
  {
    id: "kurikulum",
    label: "Kurikulum Diniyah",
    value: 60,
    icon: GraduationCap,
    color: "cream",
    suffix: "%",
    sublabel: "40% Kurikulum Umum",
    description: "Porsi pembelajaran terintegrasi" }
];
...
export default function StatsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="glow-blob glow-blob-primary w-full max-w-[600px] h-[600px] -top-[25%] right-0 translate-x-[20%]" aria-hidden="true" />
      <div className="glow-blob glow-blob-secondary w-full max-w-[500px] h-[500px] -bottom-[25%] left-0 -translate-x-[20%]" aria-hidden="true" />
