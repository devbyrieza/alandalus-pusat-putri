        ...
        <div className="flex flex-col lg:flex-row gap-14 lg:gap-24 items-start">
          ...
          >
            ...
            <p className="section-subtitle lg:ml-0 text-justify lg:text-left mb-10 max-w-lg mx-auto lg:mx-0">
              Pesantren Islam Internasional Al-Andalus Putri didukung oleh asatidzah profesional
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-4">
              {[
                ...
                <div
                  key={i}
                  className="group flex items-center gap-4 bg-white p-3.5 rounded-xl border border-secondary-100 shadow-premium-sm hover:shadow-premium-md hover:border-primary-100 transition-all duration-400"
                >
                  <div
          ...
          <div className="lg:w-[58%] grid grid-cols-1 sm:grid-cols-1 gap-3 sm:gap-4 w-full">
            {TEACHER_BACKGROUNDS.map((item, idx) => (
              <motion.div
                ...
                className="group relative bg-white p-5 rounded-xl border border-secondary-100 shadow-premium-sm hover:shadow-premium-md hover:border-primary-100 flex items-start gap-3.5 overflow-hidden transition-all duration-400"
              >
