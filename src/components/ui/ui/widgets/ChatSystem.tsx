      ...
      <AnimatePresence>
        {isAiOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-ink-950/40  z-9990 md:hidden overscroll-contain"
        ...
        <AnimatePresence>
          {isMenuOpen && !isAiOpen && (
            <motion.div
              ...
              className="bg-white rounded-xl shadow-premium-2xl border border-surface-100 p-2 mb-4 w-[280px] overflow-hidden"
            ...
            >
              ...
              <div className="space-y-1">
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-primary-100 flex items-center justify-center shrink-0 group-hover:bg-primary-600 transition-colors whitespace-nowrap shrink-0">
          ...
          <AnimatePresence>
            {showTooltip && !isMenuOpen && !isAiOpen && (
              <motion.div
                ...
                className="bg-white px-4 py-3 rounded-xl shadow-premium-lg border border-surface-100 items-center gap-3 mb-2 max-w-[220px] relative hidden md:flex"
              >
                <div className="flex-1">
