    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-16 sm:bottom-6 left-3 sm:left-6 z-40 bg-white rounded-2xl shadow-premium-xl border border-surface-100 px-4 py-3 flex items-center gap-3 max-w-[min(260px,calc(100vw-4.5rem))]"
        >
