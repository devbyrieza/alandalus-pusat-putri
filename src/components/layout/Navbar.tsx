...
export default function Navbar() {
  ...
  return (
    <header
      className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-primary-950/95 backdrop-blur-md border-b border-primary-800 shadow-xl py-3"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        {/* DESKTOP NAV LINKS */}
        <nav className="hidden lg:flex items-center gap-1 bg-primary-900/60 p-1.5 rounded-2xl border border-primary-800 backdrop-blur-md">
          {navLinks.map((link) => {
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-primary-950 border-b border-primary-800 overflow-hidden px-4 py-6 space-y-4 shadow-2xl"
          >
